...
<div class="wrapper">
    <div class="container wrapper__lk">
        <div class="row">
            <div class="col-md-2">
                <div class="wrapper__menu">
                    <div class="menu__lk">
                        <div class="menu__lk-header">
                            <img src="img/chel.png" alt="">
                            <p class="menu__lk_header-clientName"><?php echo "$firstname $lastname"; ?></p>
                            <p class="menu__lk_header-clientTarif">Тариф: <?php isRate($level); ?></p>
                        </div>
                        <div class="menu__lk-content">
                            <ul>
                                <li><a href="/">Главная <img src="img/home.png" class="menu__lk-content_img" alt=""></a></li>
                                <li><a href="review.php">Отзывы <img src="img/pen.png" class="menu__lk-content_img" alt=""></a></li>
                                <li><a href="posts.php">Новости <img src="img/news-menu.png" class="menu__lk-content_img" alt=""></a></li>
                                <li><a href="">Контакты <img src="img/letter.png" class="menu__lk-content_img" alt=""></a></li>
                                <li><a href="">Тарифы <img src="img/cards.png" class="menu__lk-content_img" alt=""></a></li>
                            </ul>
                        </div>
                        <div class="menu__lk-social">
                            <ul>
                                <li><a href="https://www.instagram.com/starbitclub_official/"><img class="header-lk-social" src="img/insta.png" alt=""></a></li>
                                <li><a href="https://www.youtube.com/channel/UCPx7Yj8ra7FKTwEmG5SNiRw"><img class="header-lk-social" src="img/yt.png" alt=""></a></li>
                                <li><a href="https://vk.com/starbitclub"><img class="header-lk-social" src="img/vk.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-10">
                <div class="tabs">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#home">Автоматизация торговли</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="menu1" class="tab-pane fade in active">
                            <div id="first-step">
                                <div class="row">
                                    <div class="col-md-12 centered">
                                        ...
                                        <p class="desc-join">Для того чтобы стать членом клуба необходимо выполнить 4
                                            простых
                                            условия:</p>
                            ...
                            <div id="second-step" style="display: none">
                                <div class="col-md-12 centered">
                                    ...
                                    <a href="tg://resolve?domain=bitstarclub_bot"><img src="img/click-me.png"
                                                                                       class="click-me wow fadeIn"
                                                                                       data-wow-delay="5s"
                                                                                       alt=""></a><br>
                            ...
                            <div id="third-step" class="centered" style="display: none">
                                ...
                                <p class="desc">Вам необходимо произвести оплату членского взноса<br>
                                    <span class="dark-red">но</span>, прежде чем вносить членский взнос вам необходимо
                                    узнать свой
                                    ID в нашем
                                ...
                                <form id="telegram_form">
                                    ...
                                    <input type="tel" name="telegram_id" class="field__telegramId" id="telegram__id"
                                           required placeholder="Введите ваш id телеграмма">
                            ...
                            <div id="four-step" class="centered" style="display: none">
                                ...
                                <p class="desc">Оплата членского взноса. Выберите желаемый тариф<span
                                            class="dark-red">*</span></p>
                                <div class="row">
                                    <div class="item col-md-4 col-lg-4">
                                        <table border="1">
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="summ">5000</span><img src="img/valuta.png" alt=""
                                                                                       class="valuta">
                                                    <p>1 месяц</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="button" data-toggle="modal"
                                                            data-target="#oplataStandart" name="btnStandart"
                                                            class="btn-join">Оплатить
                                                    </button>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="item col-md-4 col-lg-4">
                                        <table border="1" class="second">
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="summ">30000</span><img src="img/valuta.png" alt=""
                                                                                        class="valuta">
                                                    <p>безлимит</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="button" data-toggle="modal" data-target="#oplataVip"
                                                            name="btnVip" class="btn-join">Оплатить
                                                    </button>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="item col-md-4 col-lg-4">
                                        <table border="1">
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="summ">12000</span><img src="img/valuta.png" alt=""
                                                                                        class="valuta">
                                                    <p>3 месяца</p>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="button" data-toggle="modal"
                                                            data-target="#oplataPremium" name="btnPremium"
                                                            class="btn-join">Оплатить
                                                    </button>
                                                </td>
                                            </tr>
                                ...
                                <p class="new-people"><span class="dark-red">*</span>Своим новым членам мы рекомендуем
                                    базовый тариф
                                    - «Standart»</p>
                        ...
                        <div id="menu2" class="tab-pane fade centered">
                            ...
                            <form id="changeProfile">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" class="field-change" style="display: none;" name="id"
                                               value="<?php echo $id_ses; ?>">
                                        <p class="name-change-field">Фамилия:</p>
                                        <input type="text" class="field-change" name="lastname"
                                               value="<?php echo $lastname; ?>">
                                        <p class="name-change-field">Имя:</p>
                                        <input type="text" class="field-change" name="firstname"
                                               value="<?php echo $firstname; ?>">
                                        <p class="name-change-field">Email:</p>
                                        <input type="email" class="field-change" name="email-reg"
                                               value="<?php echo $email; ?>">
                                        <p class="name-change-field">Телефон:</p>
                                        <input type="text" class="field-change" name="phone"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="field-change" name="pas-reg"
                                               value="<?php echo $pass; ?>">
                                    </div>
                                    <div class="resultChange"
                                         style="z-index: 99999999; position:relative; color: #00c700;"></div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=PC&sum=5&amount_due=5&formcomment=standart_level&short-dest=standartt&label=<?php echo $id_ses; ?>"><img
                                        src="img/yandex-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=MC&sum=5&amount_due=5&formcomment=standart_level&short-dest=standartt&label=<?php echo $id_ses; ?>"><img
                                        src="img/visa-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=AC&sum=5&amount_due=5&formcomment=standart_level&short-dest=standartt&label=<?php echo $id_ses; ?>"><img
                                        src="img/master-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <p class="centered check-payment">Выберите способ оплаты:</p>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=PC&sum=30000&amount_due=30000&formcomment=vip_level&short-dest=vip&label=<?php echo $id_ses; ?>"><img
                                        src="img/yandex-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=MC&sum=30000&amount_due=30000&formcomment=vip_level&short-dest=vip&label=<?php echo $id_ses; ?>"><img
                                        src="img/visa-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=AC&sum=30000&amount_due=30000&formcomment=vip_level&short-dest=vip&label=<?php echo $id_ses; ?>"><img
                                        src="img/master-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="#"><img src="img/btc-oplata.jpg" alt="" class="img-oplata"></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <p class="centered check-payment">Выберите способ оплаты:</p>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=PC&sum=15000&amount_due=15000&formcomment=premium_level&short-dest=premium&label=<?php echo $id_ses; ?>"><img
                                        src="img/yandex-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=MC&sum=15000&amount_due=15000&formcomment=premium_level&short-dest=premium&label=<?php echo $id_ses; ?>"><img
                                        src="img/visa-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="https://money.yandex.ru/quickpay/confirm.xml?receiver=410016292538129&quickpay-form=shop&targets=Спасибо%20что%20выбрали%20нас&paymentType=AC&sum=15000&amount_due=15000&formcomment=premium_level&short-dest=premium&label=<?php echo $id_ses; ?>"><img
                                        src="img/master-oplata.jpg" alt="" class="img-oplata"></a>
                        </div>
                        <div class="col-md-3">
                            <a href="#"><img src="img/btc-oplata.jpg" alt="" class="img-oplata"></a>
