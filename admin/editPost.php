    ...
    <div class="container">
        ...
        <div class="form-white-reg">
            <div class="admin-edit-post">
                <div class="row">
                    <div class="col-md-12">
                        <p class="titleEditPost">Добавление в телеграм</p>
                        <?php
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="row-posts">
                                <form action="editPost.php" method="post">
                                    ...
                                    <div class="col-post">
                                        <button name="streamTelegram" class="streamTelegram">Опубликовать</button>
                                    </div>
                                </form>
                            </div>
                        <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="titleEditPost">Отображение новостей</p>
                        <?php
/*                        $sql1 = "SELECT * FROM `news` ORDER BY id DESC LIMIT 5";
                        mysqli_set_charset($link, 'utf8');
                        ...
                        while ($row1 = mysqli_fetch_array($result)) {
                            ...
                            $date = $row1['date'];
                            $author = $row1['author'];
                            $share_telegram = $row1['share_telegram'];
                            */?><!--
                            <div class="row-posts">
                                <form action="editPost.php" method="post">
                                    <div class="col-post">
                                        <input class="id-post" disabled name="id_post" value="<?php /*echo $id; */?>">
                                    </div>
                                    <div class="col-post">
                                        <p class="title-post"><?php /*echo $title; */?></p>
                                    </div>
                                    ...
                                    <div class="col-post">
                                        <button name="" class="streamTelegram">Опубликовать</button>
                                    </div>
                                </form>
                            </div>
                        --><?php /*} */?>
